...
@m.Constraint(m.COMP, doc='Pure product i can only be produced by at most 1 rectifying section')
def logic5(m, i):
    if i in m.PRE_i:
...
@m.Constraint(m.COMP, doc='Pure product i can only be produced by at most 1 stripping section')
def logic6(m, i):
    if i in m.PST_i:
